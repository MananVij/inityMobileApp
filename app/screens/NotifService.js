...
export default class NotifService {
  ...
  localNotif(soundName) {
    ...
    PushNotification.localNotification({
      ...
      bigText: 'Please select category of your recent expense.', // (optional) default: "message" prop
      color: colors.logoColor, // (optional) default: system default
      ...
      title: 'Inity', // (optional)
      message: 'You just made a transaction. Please select the category of the expense you just made.', // (required)
